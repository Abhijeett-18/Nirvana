    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 mb-4">
          <h3 class="fw-bold text-center fs-1 mb-3"><?php echo $category_name; ?></h3> 
        </div>
        <?php
          ...
          <div class="card h-100 border-start-0 border-end-0 border-top-0 shadow-lg p-2">
            <div class="row g-0 d-flex align-items-center"> 
              <div class="col-3 d-flex justify-content-center align-items-center"> 
                <img src="images/<?php echo $food_data['image']?>" class="img-fluid rounded-start" 
              ...
              <div class="col-9">
                <div class="card-body p-1"> 
                  ...
                  <p class="card-text fw-light mb-0" style="font-size: 15px;"><?php echo $food_data['description']?>
